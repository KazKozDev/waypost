"""Frozen pre-request-v2 L0 baseline for the routing smoke evaluation.

Copied before implementation; does not import current classifier heuristics.
"""
from __future__ import annotations

import re

from waypost.schemas import Capability, ChatRequest, RequestProfile, Tier
